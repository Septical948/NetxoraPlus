...
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string,(string Es,string En)> S=new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Nav.LongTransactionsOracle"]=("Sesiones / Transacciones","Sessions / Transactions"), ["Nav.BlockingOracle"]=("Locks y bloqueos","Locks & Blocking"),
        ["Nav.LongTransactionsMySql"]=("Transacciones InnoDB","InnoDB Transactions"), ["Nav.BlockingMySql"]=("Locks InnoDB","InnoDB Locks"),
        ...
        ["Nav.AlertInbox"]=("Bandeja de alertas","Alert Inbox"), ["Nav.History"]=("Historial de incidentes","Incident History"), ["Nav.Operations"]=("Operaciones de incidentes","Incident Operations"), ["Nav.Assistant"]=("Conexiones / Perfiles","Connections / Profiles"),
        ...
        ["Profiles.HostRequired"]=("Host obligatorio.","Host is required."), ["Profiles.Testing"]=("Probando conexión...","Testing connection..."), ["Profiles.SavedProfile"]=("PERFIL GUARDADO","SAVED PROFILE"), ["Profiles.Profile"]=("PERFIL","PROFILE"), ["Profiles.Engine"]=("MOTOR","ENGINE"), ["Profiles.Host"]=("HOST / IP","HOST / IP"), ["Profiles.Port"]=("PUERTO","PORT"), ["Profiles.Database"]=("BASE / SERVICIO","DATABASE / SERVICE"), ["Profiles.Username"]=("USUARIO","USERNAME"), ["Profiles.PasswordLabel"]=("CONTRASEÑA · SOLO SESIÓN","PASSWORD · SESSION ONLY"), ["Profiles.CredentialHelp"]=("Las credenciales se usan solo durante la sesión actual. Los perfiles guardados nunca almacenan la contraseña.","Credentials are used only for the current session. Saved profiles never store the password."), ["Profiles.ConnectionStatus"]=("ESTADO DE CONEXIÓN","CONNECTION STATUS"), ["Profiles.ConnectionOk"]=("CONEXIÓN CORRECTA","CONNECTION SUCCESSFUL"), ["Profiles.ConnectionFailed"]=("CONEXIÓN FALLIDA — revisá los datos antes de continuar.","CONNECTION FAILED — review the connection details before continuing."), ["Profiles.Collecting"]=("Recolectando evidencia...","Collecting evidence..."),
