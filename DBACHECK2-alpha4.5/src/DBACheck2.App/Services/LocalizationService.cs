...
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string,(string Es,string En)> S=new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Profiles.Title"]=("ASISTENTE DBA + PERFILES DE SERVIDOR","DBA ASSISTANT + SERVER PROFILES"), ["Profiles.Save"]=("GUARDAR","SAVE"), ["Profiles.Load"]=("CARGAR","LOAD"), ["Profiles.Use"]=("USAR PERFIL","USE PROFILE"),
